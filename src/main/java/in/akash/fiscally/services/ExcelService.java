        ...
        try(Workbook workbook = new XSSFWorkbook()){
            ...
            IntStream.range(0, incomes.size())
                    .forEach(i -> {
                        ...
                        row.createCell(1).setCellValue(income.getCategoryId() != null ? income.getCategoryName() : "N/A");
        ...
        try(Workbook workbook = new XSSFWorkbook()){
            ...
            IntStream.range(0, expenses.size())
                    .forEach(i -> {
                        ...
                        row.createCell(1).setCellValue(expense.getCategoryId() != null ? expense.getCategoryName() : "N/A");
